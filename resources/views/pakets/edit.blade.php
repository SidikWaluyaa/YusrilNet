				...
				<div class="container-fluid">
								...
								<div class="d-flex justify-content-between align-items-center mb-4">
												<div>
																...
																<p class="text-muted small mb-0">Perbarui informasi paket: {{ $paket->nama }}</p>
												</div>
								...
								<div class="card border-0 shadow-sm">
												<div class="card-body p-4">
																<form action="{{ route("admin.pakets.update", $paket->id) }}" method="POST">
																								...
																								<div class="col-md-6">
																												...
																												<div class="input-group">
																																...
																																<select name="duration_unit" class="form-select" style="max-width: 100px;">
																																				<option value="jam" {{ old("duration_unit", $unit) == "jam" ? "selected" : "" }}>
																																								Jam</option>
																																				<option value="hari"
																																								{{ old("duration_unit", $unit) == "hari" ? "selected" : "" }}>Hari</option>
																																</select>
																												</div>
																								</div>
																								...
																								<div class="col-12">
																												...
																												<div class="d-flex gap-3">
																																<div class="form-check">
																																				<input class="form-check-input" type="radio" name="available" id="available_yes"
																																								value="1" {{ old("available", $paket->available) == 1 ? "checked" : "" }}>
																																				<label class="form-check-label" for="available_yes">
																																								<i class="fas fa-check-circle text-success me-1"></i>Tersedia
																																				</label>
																																</div>
																																<div class="form-check">
																																				<input class="form-check-input" type="radio" name="available" id="available_no"
																																								value="0" {{ old("available", $paket->available) == 0 ? "checked" : "" }}>
																				...
																				<!-- Actions -->
																				<div class="d-flex border-top mt-4 gap-2 pt-3">
																								<a href="{{ route("admin.pakets.index") }}" class="btn btn-outline-secondary">
